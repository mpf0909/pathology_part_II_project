...
MIN_NUCLEI = 3
STRIDE = 256
GEOJSON_DIR = "../universal-stardist/universal-stardist-geojsons/"
PATCHES_DIR = "../universal-stardist/universal-stardist-patches/"
CSV_DIR = "../universal-stardist/universal-stardist-csvs/"
CURRENT_STAIN = "CK"
...
EXCEPTIONS = ['../universal-stardist/universal-stardist-geojsons/POST_IHC_PS23-18359_D1_adenoma_HE-CK_aligned.ome.tif - Image0.geojson',
              '../universal-stardist/universal-stardist-geojsons/POST_IHC_PS23-24970_A1_PS23-09489_A1_carcinoma_HE-CK_aligned.ome.tif - Image0.geojson']
    ...
    for filename in os.listdir(GEOJSON_DIR):
        ...
        if filename.lower().endswith(".geojson"):
            ...
            try:
                ...
                print("corresponding_csv", corresponding_csv)
                updated_csv = re.sub(r"(HE-(?:CD3|CK))", r"\1.svs", corresponding_csv)
                print("updated_csv", updated_csv)
