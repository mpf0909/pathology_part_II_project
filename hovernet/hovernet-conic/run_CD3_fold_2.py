...
if __name__ == "__main__":
    ...
    FOLD_IDX = 0
    WORKSPACE_DIR = '/rds/user/mf774/hpc-work/part_II_project/in-house/training-CD3/'
    SAVE_ROOT = f'{WORKSPACE_DIR}/models/baseline/'

    splits = joblib.load('/rds/user/mf774/hpc-work/part_II_project/in-house/training-CD3/data/fold_2_splits.dat')
    ...
    save_path_ = f'{SAVE_ROOT}/fold_2_{FOLD_IDX:02d}/'
