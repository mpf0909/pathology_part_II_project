...
if __name__ == "__main__":
    ...
    splits = joblib.load('/rds/user/mf774/hpc-work/part_II_project/in-house/training-CK/fold_2_splits.dat')
    ...
    save_path_ = f'{SAVE_ROOT}/fold_2_second_phase_48_to_go{FOLD_IDX:02d}/'
