...
application="python /rds/user/mf774/hpc-work/part_II_project/hovernet/hovernet-conic/inference-results/final-test-inference/gen_CK_inference_files_to_analyse.py --data_dir \"$DATA_DIR\" --out_dir \"$OUT_DIR\""
