...
application="python /rds/user/mf774/hpc-work/part_II_project/lizard/hover_net-conic/notebooks/final-test/run_CK_inference.py --data_dir '$DATA_DIR' --out_dir '$OUT_DIR'"
