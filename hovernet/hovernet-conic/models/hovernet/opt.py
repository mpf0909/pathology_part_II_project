            ...
            },
            {
                'run_info': {
                    ...
                    'net': {
                        ...
                        # None to start from scratch
                        'pretrained': -1,
                        # 'pretrained': '/rds/user/mf774/hpc-work/part_II_project/in-house/test-training/models/baseline/00/model/00/net_epoch=2.tar'
                        # 'pretrained': '/rds/user/mf774/hpc-work/part_II_project/in-house/training-CK/models/baseline/fold_2_00/model/01/net_epoch=2.tar'
                    },
                },
                'target_info': {
                    'gen': (None, {}),
