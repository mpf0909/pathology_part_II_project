...
class Config(object):
    ...
    def __init__(self):
        ...
        self.log_dir = "/rds/user/mf774/hpc-work/part_II_project/hovernet/original-hovernet/cpm17/hover_net/training-results" # where checkpoints will be saved

        # paths to training and validation patches
        self.train_dir_list = [
            "/rds/user/mf774/hpc-work/part_II_project/opensource/cpm17/patches/train/540x540_164x164/"
        ]
        self.valid_dir_list = [
            "/rds/user/mf774/hpc-work/part_II_project/opensource/cpm17/patches/valid/540x540_164x164"
        ]
