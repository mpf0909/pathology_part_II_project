...
class Config(object):
    ...
    def __init__(self):
        ...
        self.dataset_name = "CPM17" # extracts dataset info from dataset.py
        self.log_dir = "/rds/user/mf774/hpc-work/part_II_project/hovernet/hover_net/logs/cpm17/" # where checkpoints will be saved

        # paths to training and validation patches
        self.train_dir_list = [
            "/rds/user/mf774/hpc-work/part_II_project/hovernet/hover_net/dataset/training_data/CPM17/CPM17/train/540x540_164x164/"
        ]
        self.valid_dir_list = [
            "/rds/user/mf774/hpc-work/part_II_project/hovernet/hover_net/dataset/training_data/CPM17/CPM17/valid/540x540_164x164/"
        ]
